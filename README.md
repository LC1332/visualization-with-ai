...
在分析数据的时候，我们经常会绘制很多数据图表。在AI辅助编程的当下，我发现我在实际工作中，越来越多的绘制变为由AI一起协同开发。绘制出来的表格也越来越丰富，能够支持更大数据，更高维度，更多交互的可视化。


[TODO: 配图]

当然，在这样工作大半年之后，我突然发现这里面使用的flask, d3.js等技术，甚至是plotly一些深度的指令，已经超出了我原有的代码认识。所以我希望给自己建立一门课程，来探究如何用AI辅助进行可视化。如果你也正好需要学习如何将科学中的数据进行可视化，也可以查看这门课程。如果你也有相关的case需要探究，也可以和我商量进行merge。 by [李鲁鲁](https://github.com/LC1332)

## 项目受众

- 受众，如果你希望提升和探究自己对科学数据的可视化能力。
- 本课程的理念是“尽可能使用prompt进行编程”，即开发过程中尽可能仅输入需求文字。所以原则上，你只要会运行代码就可以。
- 尽管如此，需要了解基础的编程知识，比如数据结构字典、列表等等。
